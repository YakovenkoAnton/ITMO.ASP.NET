<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Summary.aspx.cs" Inherits="ITMO.ASP.NET.Lab4.Summary" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table>
                ...
                <tbody>
                    <% var yesData = ITMO.ASP.NET.Lab4.ResponseRepository.GetRepository().GetAllResponses().Where(r => r.WillAttend.Value);
